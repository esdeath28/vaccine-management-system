 ...
 * @author USER
 */
public class hospitalCustomer extends javax.swing.JFrame {
    ...
    public hospitalCustomer(int x, int y, String hospitalID) {
        initComponents();
...
.executeQuery(" select customer.customer_id,customer_name,datediff(year,date_of_birth,getdate()) as age,customer_adress,customer_phn_no from customer inner join accounts on customer.customer_id=accounts.customer_id  where accounts.hospital_id='"+hosID+"'");
...
while (resultSet.next()) {
    ...
    String ddiff=    resultSet.getString("age");
    
    String caddress=    resultSet.getString("customer_adress");
    
    String cphn=   resultSet.getString("customer_phn_no");
    
  
     
    
    String availableVac[]={cid,cname,ddiff,caddress,cphn};
...
e.printStackTrace();
    ...
    private void initComponents() {
        ...
        customer_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/customerHover.png"))); // NOI18N
        ...
        availablevacs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "customer_id", "customer_name", "age", "customer_adress", "customer_phn_no"
            }
        ));
        jScrollPane1.setViewportView(availablevacs);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 230, 690, 390));

        jLabel1.setText("Search By");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 180, 80, 30));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "all", "customer_id", "customer_name", "age", "customer_adress", "customer_phn_no" }));
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        try {
            ...
            String query="select customer.customer_id,customer_name,datediff(year,date_of_birth,getdate()) as age,customer_adress,customer_phn_no from customer inner join accounts on customer.customer_id=accounts.customer_id  where accounts.hospital_id='"+hosID+"'";
            ...
            if(value.equals("all")){
                ...
                query+="and datediff(year,customer.date_of_birth,getdate())="+content;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hospitalCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hospitalCustomer().setVisible(true);
            }
        });
    }
