...
public class doctorProfile extends javax.swing.JFrame {
    ...
    public doctorProfile(int x, int y, String doctorID) {
        initComponents();
    ...
    private void adHour_MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_adHour_MouseMoved
        ...
        adHour_.setIcon(adv);
        ImageIcon dreq = new ImageIcon(getClass().getResource("requests.png"));
        requests_.setIcon(dreq);
        ImageIcon appoint = new ImageIcon(getClass().getResource("appointment.png"));
        appointments_.setIcon(appoint);
    ...
    private void edit_MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_edit_MouseClicked
        ...
        doctorProfileEdit cpe = new doctorProfileEdit (nx,ny,docID);
        cpe.setVisible(true);
        this.dispose();
