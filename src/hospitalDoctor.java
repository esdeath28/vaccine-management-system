 ...
 * @author USER
 */
public class hospitalDoctor extends javax.swing.JFrame {
    ...
    public hospitalDoctor(int x, int y, String hospitalID) {
        initComponents();
...
while (resultSet.next()) {
    ...
    String ceffects=    resultSet.getString("effects");
    ...
    String availableVac[]={cname,cage,vid,vtype,ceffects,mname,bid};
...
ResultSet rst=statement.executeQuery("select count(*) as countse from side_effects inner join accounts on side_effects.customer_id=accounts.customer_id where hospital_id='"+hosID+"'");


if(rst.next()){
     totalsideeffects=rst.getString("countse");
        ...
        System.out.println(totalsideeffects);
        effectCount.setText(totalsideeffects);
...
e.printStackTrace();
    ...
    private void initComponents() {
        ...
        effectCount = new javax.swing.JTextField();
        ...
        doctor_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/doctorHover.png"))); // NOI18N
        ...
        availablevacs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "customer_name", "age", "vaccine_id", "vaccine_type", "effects", "manufacture_name", "batch_id"
            }
        ));
        jScrollPane1.setViewportView(availablevacs);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 660, 390));

        jLabel1.setText("Search By");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 120, 80, 30));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "all", "customer_name", "vaccine_id", "vaccine_type", "effects", "manufacture_name", "batch_id" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 122, 130, 30));

        jLabel2.setText("Enter Keywords");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 120, 100, 30));
        ...
        getContentPane().add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 120, -1, -1));
        getContentPane().add(keyword, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 120, 210, 30));
        getContentPane().add(effectCount, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 610, 120, 40));

        jLabel3.setText("Total Number Of Side Effects");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 660, -1, -1));
        ...
        getContentPane().add(percentage, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 610, 100, 40));

        jLabel4.setText("Percentage");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 650, -1, 30));
...
String query="select customer.customer_name, datediff(year,customer.date_of_birth,GETDATE()) as age, vaccine.vaccine_id, vaccine.vaccine_type, side_effects.effects, vaccine.manufacture_name, vaccine.batch_id from side_effects inner join customer on side_effects.customer_id=customer.customer_id inner join accounts on customer.customer_id=accounts.customer_id inner join vaccine on accounts.vaccine_id=vaccine.vaccine_id where hospital_id='"+hosID+"'";
...
if(value.equals("all")){
    ...
    query=query+"";
...
else if(value.equals("customer_name")){
    
     query=query+" and customer."+value+" like '%"+content+"%'";
     ...
     query=query+" and side_effects."+value+" like '%"+content+"%'";
    ...
    query=query+" and vaccine."+value+" like '%"+content+"%'";
...
.executeQuery(query);
    ...
    double rows = availablevacs.getRowCount();
    
    double total=Double.parseDouble(totalsideeffects);
    
    
    double percent=(rows/(total*1.0))*100;
    String st=Double.toString(percent);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hospitalDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hospitalDoctor().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField effectCount;
