 ...
 * @author USER
 */
public class demoPanelDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        profile_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(profile_, new org.netbeans.lib.awtextra.AbsoluteConstraints(975, 28, 37, 37));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(demoPanelDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new demoPanelDoctor().setVisible(true);
            }
        });
    }
