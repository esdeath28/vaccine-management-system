...
public class hospitalInventory extends javax.swing.JFrame {
    ...
    public hospitalInventory(int x, int y, String hospitalID) {
        initComponents();
...
.executeQuery(" select vaccine.vaccine_id,batch_id,manufacturer_id,manufacture_name,importer_id,importer_name,vaccine_type,cost from vaccine inner join inventory on vaccine.vaccine_id=inventory.vaccine_id where inventory.hospital_id='"+hosID+"'");
...
e.printStackTrace();
    ...
    private void initComponents() {
        ...
        inventory_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventoryHover.png"))); // NOI18N
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        try {
            ...
            String query=" select vaccine.vaccine_id,batch_id,manufacturer_id,manufacture_name,importer_id,importer_name,vaccine_type,cost from vaccine inner join inventory on vaccine.vaccine_id=inventory.vaccine_id where inventory.hospital_id='"+hosID+"'";
